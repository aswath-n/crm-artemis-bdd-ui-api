...
public class ProviderNormalizedAddress {
    ...
    @JsonProperty("normalizedAddId")
    private Integer normalizedAddId;
    ...
    @JsonProperty("normalizedAddId")
    public Integer getNormalizedAddId() {
        return normalizedAddId;
    }

    @JsonProperty("normalizedAddId")
    public void setNormalizedAddId(Integer normalizedAddId) {
        this.normalizedAddId = normalizedAddId;
    }
