...
public class APIStoreOutboundCorrespondenceTemplateController {

    private String apiBffCorrespondence = ConfigurationReader.getProperty("apiBffCorrespondence");
    private String createCorrespondence = "/ecms/correspondence/outbound/template";
    ...
    private final ThreadLocal<String> correspondenceType = ThreadLocal.withInitial(() ->"maersk Outbound Correspondence Template");
    ...
    @And("I create Outbound Correspondence Template save request with {string} request details and run it")
